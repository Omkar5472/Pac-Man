document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateHighestScore = () => {
        ...
        const highestScoreDisplay = document.getElementById('highestScoreValue');
    ...
    const endGame = () => {
        ...
        updateHighestScore();
            alert('Game Over. Your score was ' + score + '. Highest Score: ' + localStorage.getItem('highestScore'));
    };
    ...
    const movePacman = (e) => {
        ...
        let isArrowKey = e.key.includes('Arrow');
        let isMoving = isArrowKey && (e.repeat || e.type === 'keydown');
